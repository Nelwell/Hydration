...
public class WaterRepository {
    ...
    public void insert(WaterRecord record) {
        ...
        new InsertWaterAsync(waterDAO).execute(record); // when called, calls doInBackground
    ...
    public void update(WaterRecord record) {
        // TODO update record asynchronously in the background
        new UpdateWaterAsync(waterDAO).execute(record); // when called, calls doInBackground
        // method automatically and passes 'record' arg
    }
