...
//        waterViewModel.insert(example);
        ...
        // Insert blank days, so there is a record in the databse for each day of the week.
        // DAO has conflict strategy = ignore for duplicate days, so if any of the days are already
        // in the database, they will be ignored, not added again
        for (String day : DAYS) {
